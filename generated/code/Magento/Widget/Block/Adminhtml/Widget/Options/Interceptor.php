...
class Interceptor extends \Magento\Widget\Block\Adminhtml\Widget\Options implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getMainFieldset');
        return $pluginInfo ? $this->___callPlugins('getMainFieldset', func_get_args(), $pluginInfo) : parent::getMainFieldset();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addFields');
        return $pluginInfo ? $this->___callPlugins('addFields', func_get_args(), $pluginInfo) : parent::addFields();
    }
